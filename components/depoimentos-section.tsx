...
const fallbackTestimonials: Depoimento[] = [
	{
		id: "1",
		name: "Ana Silva",
		since: "2015",
		...
		async function fetchTestimonials() {
			try {
				...
				if (data && data.length > 0) {
					// Ensure the data matches the Depoimento type
			...
			<div className="container px-4 md:px-6 relative z-10">
				...
				>
					...
					<p className="max-w-3xl mx-auto text-body-large text-white/90 leading-relaxed">
						<span className="font-semibold text-yellow-400">Histórias e experiências</span> de quem viveu e
						construiu a FK ao longo desses{" "}
						<span className="font-bold text-pink-400">10 anos</span>.
					</p>
							...
							<Card className="glass border-white/20 shadow-2xl hover-lift card-3d">
								<CardContent className="pt-8 pb-8">
									<div className="flex flex-col items-center text-center">
										...
										<p className="text-body-large text-white leading-relaxed italic font-light">
										...
										<div className="flex items-center gap-4">
											...
											<div className="text-left">
												<h4 className="text-title text-white">{testimonials[currentIndex].name}</h4>
				...
				<div className="max-w-2xl mx-auto">
					<Card className="glass border-white/20 shadow-2xl hover-lift">
						<CardContent className="pt-8">
							<h3 className="text-title font-playfair text-center mb-6 text-white">

		...
		<section id="evento" className="py-20 md:py-32 bg-white dark:bg-gray-900">
			<div className="container px-4 md:px-6">
				...
				>
					...
					>
						Celebração de{" "}
						<span className="highlight-gradient">10 Anos!</span>
					</h2>
					<p className="max-w-3xl mx-auto text-lg text-gray-700 dark:text-gray-300">
						Uma noite{" "}
						<span className="highlight-primary">inesquecível</span> para celebrar
						uma década de{" "}
				...
				<div className="max-w-4xl mx-auto">
					...
					>
						O que{" "}
						<span className="highlight-gradient">esperar</span>
					</h3>

  ...
  return (
    <section id="adesivos" className="py-20 md:py-32 bg-white dark:bg-gray-900">
      <div className="container px-4 md:px-6">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900 dark:text-white">Sistema de Adesivos FK</h2>
                  ...
                  <CardContent className="pt-6">
                    <div className="flex flex-col md:flex-row gap-8 items-center">
                      ...
                      <div className="w-full md:w-1/2">
                        <h3 className="text-2xl font-semibold mb-4 text-primary">Adesivos da Atração</h3>
                ...
                <Card className="border-2 border-primary/10">
                  <CardContent className="pt-6">
                    <div className="flex flex-col md:flex-row gap-8 items-center">
                      ...
                      <div className="w-full md:w-1/2">
                        <h3 className="text-2xl font-semibold mb-4 text-primary">Adesivos de Gênero</h3>
                        <p className="text-gray-700 dark:text-gray-300 mb-4">
                ...
                <Card className="border-2 border-primary/10">
                  <CardContent className="pt-6">
                    <div className="flex flex-col md:flex-row gap-8 items-center">
                      ...
                      <div className="w-full md:w-1/2">
                        <h3 className="text-2xl font-semibold mb-4 text-primary">Adesivos de Beijo</h3>
                        <p className="text-gray-700 dark:text-gray-300 mb-4">
